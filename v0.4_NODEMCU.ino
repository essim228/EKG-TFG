...
char writeAPIKey[]= "53SY9YFM8O3PMIKU";
unsigned long lastConnectionTime = 0;
const unsigned long postingInterval = 20L * 1000L;
const char mqttUserName[] = "HjQwLQoqMBcQHxM9OAgoIQc"; 
const char clientID[] = "HjQwLQoqMBcQHxM9OAgoIQc";
const char mqttPass[] = "722Ym94Gfvgfq9d+xe61FS92";
...
//Parametros para la instancia PubSubClient
...
//Programas para el MQTT
//Procesado del envio de mensajes
...
void mqttPublish(long ChannelID, String message) {
  String topicString ="channels/" + String( ChannelID ) + "/publish/fields/1";
...
while (!Serial) { 
  ...
  if (WiFi.status() != WL_CONNECTED) {
    ...
    mqttPublish( channelID, (String(Serial.read())));
  }
